...
data Persona = UnaPersona {edad :: Number, items :: [Item], experiencia :: Number}
data Criatura = UnaCriatura {peligrosidad :: Number, requisito :: Requisito}
...
-- Sería más correcto con un foldl!
...
-- cuantaExperienciaAlEnfrentar unaPersonaDeEjemplo [siempredetras, gnomo 10, fantasma 3 requisitoFantasma, fantasma 1 (>10).experiencia]
...
zipWithIf funcion condicion (cabezaLista1 : restoLista1) (cabezaLista2 : restoLista2) 
     | condicion cabezaLista2 = funcion cabezaLista1 cabezaLista2 : zipWithIf funcion condicion restoLista1 restoLista2
...
-- Si vamos por la alternativa con zipwithif en el punto d...
